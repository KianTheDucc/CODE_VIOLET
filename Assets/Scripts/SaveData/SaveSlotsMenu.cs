...
public class SaveSlotsMenu : Menu
{
    ...
    {
        DataStorageManager.instance.DeleteProfileData(saveSlot.GetProfileId());
    ...
    public void ActivateMenu(bool isLoadingGame)
    {
        ...
        Dictionary<string, GameData> profilesGameData = DataStorageManager.instance.GetAllProfilesGameData();
